...
syscall_src += arch-x86/syscalls/name_to_handle_at.S
syscall_src += arch-x86/syscalls/nanosleep.S
syscall_src += arch-x86/syscalls/open_by_handle_at.S
...
syscall_src += arch-x86/syscalls/remap_file_pages.S
...
syscall_src += arch-x86/syscalls/setfsgid.S
syscall_src += arch-x86/syscalls/setfsuid.S
...
syscall_src += arch-x86/syscalls/vhangup.S
